...
const ManagerDashboard = () => {
    ...
    // We can use any endpoint that requires a restaurant link
    const { error } = useQuery({
        queryKey: ["manager-check-linked"],
        queryFn: () => analyticsAPI.getSuccessfulOrders(),
        retry: false, // Ensure we don't retry if it fails
    });
            ...
            <div className="flex w-full">
                ...
                >
                    <div className="flex flex-col h-screen overflow-hidden">
                        {/* User Profile */}
                        <SidebarUserProfile profilePath="/manager/profile" />
                ...
                <div className="flex-1 w-full lg:ml-64">
                    {/* Check for Unlinked Manager Status */}
                    {isUnlinkedManager ? (
                        <UnlinkedRestaurantMessage role="Manager" />
                    ) : (
                        <Outlet />
                    )}
                </div>
